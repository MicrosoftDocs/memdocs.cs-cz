...
### <a name="improvement-to-update-device-settings-page-in-company-portal-app-for-android-to-show-descriptions---7414768---"></a>Vylepšení aktualizace stránky nastavení zařízení v Portál společnosti aplikaci pro Android, aby zobrazovala popisy<!-- 7414768 -->
Na stránce Portál společnosti aplikace na zařízeních s Androidem se na stránce **aktualizovat nastavení zařízení** zobrazí seznam nastavení, která musí uživatel aktualizovat, aby splňoval předpisy. Vylepšili jsme činnost koncového uživatele, takže uvedená nastavení se ve výchozím nastavení rozbalí, aby se zobrazil popis a tlačítko **vyřešit** (Pokud je k dispozici). Dříve byly ve výchozím nastavení sbaleny. Toto nové výchozí chování omezuje počet kliknutí, takže uživatelé mohou rychleji řešit problémy.
