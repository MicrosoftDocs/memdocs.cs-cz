...
Další informace najdete v tématu [jak omezit použití určitých kryptografických algoritmů a protokolů v souboru Schannel. dll](https://support.microsoft.com/en-us/kb/245030/) a [určit prioritu šifrovacích sad Schannel](https://msdn.microsoft.com/library/windows/desktop/bb870930.aspx). Tyto postupy neovlivňují Configuration Manager funkce.
