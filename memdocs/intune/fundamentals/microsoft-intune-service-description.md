...
description: Microsoft Intune je cloudová služba, která pomáhá spravovat zařízení s Windows, iOS/iPadOS, macOS a Androidem.
keywords: ''
author: dougeby
ms.author: dougeby
manager: dougeby
...
- Důležité aktualizace služby se také oznamují v centru pro [správu Microsoft 365](https://admin.microsoft.com/) centra zpráv. Pokud nainstalujete doprovodnou [mobilní aplikaci správce Microsoft 365](https://support.office.com/article/Office-365-Admin-Mobile-App-e16f6421-2a1a-4142-bf9d-9846600a060a), můžete dostávat oznámení na svém mobilním zařízení. Přečtěte si další informace o tom, jak pracovat s [Microsoft 365 centra zpráv](https://support.office.com/client/results?Shownav=true&ns=O365ENTADMIN&version=15&ver=15&HelpID=O365E_MCManageUpdates).

  Několik užitečných tipů:

  - Zprávy v centru zpráv Microsoft 365 jsou cílené. To znamená, že pokud vaše společnost nemá nabídku Intune pro EDU, nebudeme vám v Intune pro EDU zprávy.
  ...
  - Mobilní aplikace pro správu Microsoft 365 umožňuje prohledávat všechny zprávy a předávat oznámení, pokud jste ji chtěli sdílet s partnery ve vaší organizaci.

  - V části upravit předvolby centra zpráv se vám podíváme na **Intune** , abyste se mohli podívat na tyto zprávy, které se publikují do předplatného Intune. Pokud se zobrazí Správa mobilních zařízení pro Microsoft 365, jedná se o jinou službu, ne Intune.
...
> [!Note]
> Stav služby Intune můžete monitorovat v [centru pro správu Microsoft 365](https://admin.microsoft.com). Zvolte **Stav služby** v levém podokně. K zobrazení stavu služby můžete také použít [mobilní aplikaci správce Microsoft 365](https://support.office.com/article/Office-365-Admin-Mobile-App-e16f6421-2a1a-4142-bf9d-9846600a060a) .
...
- Změny prostředí pro koncové uživatele, které pravděpodobně budete chtít sdílet s pracovníky helpdesku nebo s koncovými uživateli. Poskytujeme obvykle 7 až 30 dnů oznámení o těchto změnách a zdokumentujte je v [uživatelském rozhraní aplikace Intune, co je nového](whats-new-app-ui.md). V případě nějaké chyby jako pravopisné opravy nebudeme obvykle vyzvat v dokumentaci. V uživatelském rozhraní je ale změna v prostředí pro registraci koncových uživatelů dostatečně významná, takže pošleme zprávu zákazníkům v centru zpráv Microsoft 365 a odkaz na novinky v uživatelském rozhraní aplikace Intune, abyste byli informováni o tom, co se mění a které mají čas k vyhodnocení a aktualizaci pokynů pro koncové uživatele, než se změny provedou v produkčním prostředí.

- Změny, které vyžadují váš zásah, se nazývají **Plán na změnu** a obvykle na ně upozorňujeme 30 dní předem. V centru zpráv Microsoft 365 kategorie konkrétně uvádí plán změny, a pokud máme přesné datum, kdy je změna v produkčním prostředí, vložíme také do pole **Act podle** data a získáte vizuální frontu a značku vysvětlení.
...
V vzácných událostech je ale k dispozici jakákoli akce po incidentu, která vyžaduje, aby se vaše služba vrátila zpět do normálního stavu, nebo velká změna, kterou jsme na základě zpětné vazby od zákazníků mohli narušit, pošleme správcům služby e-mailem informace o tom, jak jsou nastavené vaše [Předvolby komunikace Microsoft 365](https://support.office.com/article/Change-your-contact-preferences-for-communications-from-Microsoft-6f70de1b-a64d-4498-bfbd-be8c83a9c0fc) a jestli jste zahrnuli platnou (a případně pracovní)  
