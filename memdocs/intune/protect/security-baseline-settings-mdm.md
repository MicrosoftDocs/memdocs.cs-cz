...
- **Procesy aplikace Internet Explorer omezují instalaci aktivních X**   
...
- **Internet Explorer Internet Zone navigace ve Windows a snímcích napříč různými doménami**   
...
- **Akce potenciálně nežádoucí aplikace v Defenderu**  
  ...
  [Další informace](/windows/client-management/mdm/policy-csp-defender#defender-puaprotection)    
...
Další informace najdete v tématu [2.2.2 FW_PROFILE_TYPOE]( /openspecs/windows_protocols/ms-fasp/7704e238-174d-4a5e-b809-5f3787dd8acc) v dokumentaci k Windows Protocols.  
...
- **Blokovat Windows Hello pro firmy**  
  ...
  - Když se nastaví *zákaz*, zařízení zřídí Windows Hello pro firmy.
  - Pokud je nastavené na *Nenakonfigurováno*, standardní hodnoty nebudou mít vliv na nastavení zásad daného zařízení. To znamená, že aktuální stav Windows Hello pro firmy na zařízení zůstane na svém místě.

  Windows Hello pro firmy můžete zakázat při konfiguraci [registrace systému Windows](windows-hello.md)nebo jako součást profilu konfigurace zařízení pro [ochranu identity](identity-protection-configure.md).  

  - **Výchozí**: povoleno

  Pokud je toto nastavení *zakázáno*, jsou k dispozici následující nastavení.
