...
description: Přečtěte si o nových funkcích, které jsou k dispozici ve větvi Configuration Manager Technical Preview verze 1910.
ms.date: 10/18/2019
...
ms.locfileid: "88995924"
---
# <a name="features-in-configuration-manager-technical-preview-version-1910"></a>Funkce v Configuration Manager Technical Preview verze 1910

*Platí pro: Configuration Manager (větev Technical Preview)*

V tomto článku se seznámíte s funkcemi, které jsou k dispozici v Technical Preview pro Configuration Manager verze 1910. Nainstalujte tuto verzi, abyste aktualizovali a přidali nové funkce na web Technical Preview.
