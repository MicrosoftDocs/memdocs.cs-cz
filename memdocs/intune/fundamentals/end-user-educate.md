...
* **Android**
  * [Používání zařízení s Androidem s Intune](../user-help/why-enroll-android-device.md)
  * [Jak uživatelé s Androidem získávají svoje aplikace](end-user-apps-android.md)

* **iOS**
  * [Použití zařízení s iOS/iPadOS s Intune](../user-help/using-your-ios-device-with-intune.md)
  * [Jak uživatelé iOS/iPadOS získávají své aplikace](end-user-apps-ios.md)

* **Windows**
  * [Používání zařízení s Windows s Intune](../user-help/using-your-windows-device-with-intune.md)
