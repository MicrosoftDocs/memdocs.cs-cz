...
Tento řídicí panel vám pomůže zkontrolovat počítače, které jsou ve vašem prostředí spoluspravované. Grafy můžou identifikovat zařízení, která by mohla vyžadovat pozornost.<!--1356648,1358980-->
...
### <a name="co-management-status"></a>Stav spolusprávy
...
| 2149056533 (0x80180015)<br>MENROLL_E_NOTSUPPORTED | Správa mobilních zařízení není podporována. Ověřte omezení zařízení. |
...
- **ComgmtPolicyPresent**: Určuje, zda Configuration Manager zásady spolusprávy existují v klientovi. Pokud je hodnota **MDMEnrolled** `0` , zařízení není souběžně spravované na tom, jestli v klientovi existují zásady spolusprávy.
