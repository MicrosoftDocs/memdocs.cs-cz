...
description: Přečtěte si o nových funkcích, které jsou k dispozici ve větvi Configuration Manager Technical Preview verze 1904.
ms.date: 04/29/2019
...
ms.locfileid: "88995958"
---
# <a name="features-in-configuration-manager-technical-preview-version-1904"></a>Funkce v Configuration Manager Technical Preview verze 1904

*Platí pro: Configuration Manager (větev Technical Preview)*

V tomto článku se seznámíte s funkcemi, které jsou k dispozici v Technical Preview pro Configuration Manager verze 1904. Nainstalujte tuto verzi, abyste aktualizovali a přidali nové funkce na web Technical Preview.
