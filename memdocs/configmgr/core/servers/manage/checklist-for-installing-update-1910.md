---
title: Kontrolní seznam pro 1910
titleSuffix: Configuration Manager
description: Přečtěte si o akcích, které je potřeba provést před aktualizací na verzi Configuration Manager 1910.
ms.date: 12/20/2019
...
ms.locfileid: "81714231"
---
# <a name="checklist-for-installing-update-1910-for-configuration-manager"></a>Kontrolní seznam pro instalaci aktualizace 1910 pro Configuration Manager

*Platí pro: Configuration Manager (Current Branch)*

Když použijete aktuální větev Configuration Manager, můžete nainstalovat konzolovou aktualizaci pro verzi 1910, která aktualizuje vaši hierarchii z předchozí verze. <!-- baseline only statement:(Because version 1902 is also available as [baseline media](updates.md#a-namebkmkbaselinesa-baseline-and-update-versions), you can use the installation media to install the first site of a new hierarchy.)-->

Chcete-li získat aktualizaci verze 1910, je nutné použít spojovací bod služby v lokalitě nejvyšší úrovně ve vaší hierarchii. Tato role systému lokality může být v režimu online nebo offline. Pokud chcete stáhnout aktualizaci, když je spojovací bod služby offline, [použijte nástroj pro připojení služby](use-the-service-connection-tool.md).<!-- SCCMDocs#1946 -->
...
- Je-li aktualizace uvedena jako **dostupná**, je aktualizace připravena k instalaci. Před instalací verze 1910 si přečtěte následující informace [o instalaci aktualizace 1910](#about-installing-update-1910) a [Kontrolní seznam](#checklist) pro konfigurace, které se mají provést před zahájením aktualizace.
...
## <a name="about-installing-update-1910"></a>O instalaci aktualizace 1910

### <a name="sites"></a>Lokality

Nainstalujte aktualizaci 1910 v lokalitě nejvyšší úrovně ve vaší hierarchii. Spusťte instalaci z lokality centrální správy (CAS) nebo ze samostatné primární lokality. Po instalaci aktualizace v lokalitě nejvyšší úrovně mají podřízené lokality následující chování aktualizace:
...
Od 20. prosince 2019 je verze 1910 k dispozici pro všechny zákazníky, kteří chtějí instalovat. Pokud jste se dříve přihlásili k okruhu brzké aktualizace, Sledujte aktualizaci této aktuální verze větve.
...
Aby bylo možné spustit instalaci aktualizace 1910, musí každý server lokality v hierarchii používat stejnou verzi Configuration Manager. K aktualizaci na 1910 je nutné použít verzi 1806 nebo novější.
...
<!--SCCMdocs#587-->
Pokud rozšíříte Configuration Manager s jinými produkty od partnerů Microsoftu nebo Microsoftu, ujistěte se, že tyto produkty podporují verzi 1910. Tyto informace vám poskytne dodavatel produktu. Příklad najdete v [poznámkách k verzi](../../../mdt/release-notes.md)Microsoft Deployment Toolkit.
...
Chcete-li spustit kontrolu požadovaných součástí z konzoly, otevřete ovládací prostor pro **správu** a vyberte možnost **aktualizace a údržba**. Vyberte balíček aktualizace **Configuration Manager 1910** a na pásu karet vyberte **Spustit kontrolu požadovaných součástí** .
...
Zajistěte, aby byl každý server lokality a role systému lokality aktualizované na verzi 1910. V konzole nástroje přidejte sloupec **verze** do uzlů **lokality** a **distribučních bodů** v pracovním prostoru **Správa** . V případě potřeby se role systému lokality automaticky přeinstaluje, aby se aktualizovala na novou verzi.
...
Pokud používáte jakákoli rozšíření Configuration Manager, aktualizujte je na nejnovější verzi, aby podporovala Configuration Manager verze 1910.
