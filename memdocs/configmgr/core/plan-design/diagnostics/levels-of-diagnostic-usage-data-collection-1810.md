---
title: Diagnostická data a data o využití pro 1810
titleSuffix: Configuration Manager
description: Přečtěte si o konkrétních datech, která Configuration Manager shromažďuje na každé úrovni verze 1810.
ms.date: 05/13/2019
...
Pro Configuration Manager verze 1810 Tato úroveň zahrnuje následující data:
...
- ***[Aktualizováno]*** Základní konfigurace databáze: procesory, velikost paměti, nastavení paměti, Configuration Manager konfigurace databáze, Configuration Manager velikost databáze, konfigurace clusteru, konfigurace distribuovaných zobrazení a verze sledování změn  
...
- ***[Aktualizováno]*** Počet zařízení s Windows 10 Podle větve, sestavení a jedinečné doménové struktury služby Active Directory  
...
- ***[Aktualizováno]*** Prvních 10 názvů procesorů používaných na klientech a serverech  
...
- ***[Nové]*** Seznam Top SQL dotazů s algoritmem hash podle využití paměti a počtu zámků  

- ***[Přesunuto, aktualizováno]*** Agregované statistiky využití pro spolusprávu: počet klientů, kteří se někdy zaregistrovali, počet zaregistrovaných klientů, počet klientů, kteří čekají na registraci, klienti, kteří dostávají zásady, stavy zatížení, kolekce pilotního/vyloučení a chyby registrace  
...
- ***[Nové]*** Agregované statistiky používání funkce pro schválení e-mailu  

- ***[Nové]*** Počet souborů, velikost obsahu, počet služeb a počet vlastních akcí MSIs v katalogu aplikací  
...
- Statistika stavu klienta a shrnutí hlavních problémů podle verze klienta  
...
- ***[Nové]*** Počet uložených dotazů CMPivot  

- ***[Nové]*** Počet dotazů podle typu entity  
...
- ***[Nové]*** Počet skupin hranic podle konfigurace  
...
- ***[Nové]*** Počet importovaných počítačů  
...
- ***[Nové]*** Agregovaná statistika počtu UUP aktualizací, které jsou požadovány, nasazeny, prošly, nahrazeny a staženy  

- ***[Nové]*** Používání kategorií produktů UUP  

- ***[Nové]*** Počet klientů, kteří nasadili alespoň jednu aktualizaci kvality UUP nebo aktualizace funkcí UUP  

- ***[Nové]*** Hlavní kódy chyb UUP a počet ovlivněných zařízení  
...
- ***[Nové]*** Statistika provozu bodu správy (celkový počet odeslaných a přijatých koncovým bodem)  

- ***[Nové]*** Měření čítače výkonu bodu správy  
...
- ***[Nové]*** Počet klientů nabízených s možností, aby nepovolovala použití protokolu NTLM  
