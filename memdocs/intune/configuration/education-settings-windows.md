...
Vytvořit [profil konfigurace zařízení pro zabezpečení Windows 10 pro vzdělávání](education-settings-configure.md#create-a-device-profile)
...
- **Adresa URL pro vyhodnocení**: zadejte adresu URL testu, který mají uživatelé provést. Další informace o získání adresy URL najdete v dokumentaci k [provedení testu](/education/windows/take-tests-in-windows-10).
