...
3. Pomocí zásad skupiny nasaďte software do počítačů v síti.
    ...
    Další informace o tom, jak automaticky nasadit software pomocí zásad skupiny, najdete v článku [Zásady skupiny pro začátečníky](/previous-versions/windows/it-pro/windows-7/hh147307(v=ws.10)).
