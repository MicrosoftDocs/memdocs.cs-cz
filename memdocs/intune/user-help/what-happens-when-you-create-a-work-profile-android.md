...
- Ikony pracovních aplikací mají "BADGE", který vypadá jako bílá Aktovka uvnitř červeného kruhu, jak je znázorněno níže. Ikony osobních aplikací nezobrazují aktovku a budou vypadat stejně jako v současnosti.
...
Postup vytvoření pracovního profilu najdete v článku [Vytvoření pracovního profilu a registrace zařízení](enroll-device-android-work-profile.md).
