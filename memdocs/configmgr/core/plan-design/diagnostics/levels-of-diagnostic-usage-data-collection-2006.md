---
title: Diagnostická data a data o využití pro 2006
titleSuffix: Configuration Manager
description: Přečtěte si o konkrétních datech, která Configuration Manager shromažďuje na každé úrovni verze 2006.
ms.date: 08/11/2020
...
ms.locfileid: "88129633"
---
# <a name="diagnostic-and-usage-data-for-version-2006"></a>Data o diagnostice a použití pro verzi 2006
...
Pro Configuration Manager verze 2006 Tato úroveň zahrnuje následující data:
...
- Základní Configuration Manager data hierarchie lokality: seznam webů, typ, verze, stav, počet klientů, časové pásmo a stav
...
- Informace o stavu lokality

- Configuration Manager umístění pro zhroucení konzoly

- Statistika použití konzoly Configuration Manager

- Akce připojení a odpojení cloudu

- Stav poslední synchronizace s cloudovou službou Intune

- Počty chyb ze služby správy

- Použití registračního tokenu pro hromadnou registraci

- Počet klientů ve výchozím nastavení a preferovaný prohlížeč

- ***[Přesunuté]*** Konfigurace a statistika využití Brána pro správu cloudu: počty oblastí a prostředí a statistiky ověřování/autorizace  

- ***[Přesunuté]*** Informace o replice SQL AlwaysOn, využití a stav  

- ***[Nové]*** Konfigurace a stav oznámení konzoly správce

- ***[Nové]*** Konfigurace a stav kontroly stavu webu
...
- Počet aplikací Microsoft 365 Apps vytvořených pomocí řídicího panelu  
...
- Agregované statistiky o doplňcích pro Office, použití sady nástrojů Readiness Toolkit pro Office a počty klientů s Microsoft 365 aplikacemi

- Agregované statistiky o stavu doplňku pro Office

- Počet a velikost sad pilotních kolekcí pro Office pro plus

- Počet zařízení Office pro plus, která odesílají data o stavu Office
...
- ***[Aktualizováno]***  -  ***[Nové]*** pravidla inventáře softwaru, pravidla shromažďování souborů a celkový stav
...
- ***[Nové]*** Souhrnný počet událostí služby Endpoint Analytics
...
- Využití průvodce připojováním cloudových služeb
...
- ***[Nové]*** Počet nastavení dodržování předpisů nasazených kategorií, operačním systémem a zdrojem (Cloud vs on-premises)
...
- Informace o výkonu konzoly

- 25 nejběžnějších akcí, průvodců, seznamů vlastností a uzlů stromové struktury, které jsou k dispozici v konzole nástroje
...
- Počet podsítí vyloučených ze sdílené mezipaměti
...
- Agregované statistiky pro zásady rozšířené ochrany před internetovými útoky v programu Microsoft Defender
...
- Počet nasazených aktualizací Microsoft 365 aplikací  
...
- Využití skupiny Orchestration

- web Windows Update nastavení záložní konfigurace
...
- Stav posledních požadavků na novou inicializaci
...
- Počet klientů s využitím prohlížeče
